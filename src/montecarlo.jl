...
function elboMC(
    ...
    for countSample in 1:numOfSamples
...
function logLikelihoodIS(
    ...
    for countObservation in 1:n
        ...
        logLikelihood += logsumexp(modelLogLikelihood .- guideLogLikelihood) - log(numOfSamples)
    end
...
function loglikelihoodEnumerate(
    ...
    for countObservation in 1:n
        ...
        loglikelihood += logsumexp(conditionalLoglikehood)
    end
    return loglikelihood
end
